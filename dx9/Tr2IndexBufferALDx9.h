...
public:
	...
	Tr2ALMemoryType GetMemoryClass() const { return m_pool == D3DPOOL_DEFAULT ? AL_MEMORY_VIDEO : AL_MEMORY_MANAGED; }
...
#endif //Tr2IndexBufferALDx9Dx9_h_
